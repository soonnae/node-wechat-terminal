...
angular.module("Services").factory("utilFactory", ["$q", "$rootScope", "confFactory", function(e, t, o) {
    ...
    var u = {
        ...
        setCookie: function(e, t, o) {
            ...
            var r = "expires=" + n.toUTCString() + "; Secure"; // Ensure Secure attribute is set
        ...
        globalEval: function(e) {
            // Avoid using eval; use a safer alternative
            if (e && /\S/.test(e)) {
                try {
                    (new Function(e))();
                } catch (error) {
        ...
        evalVal: function(e) {
            var t, o = "a" + this.now();
            this.globalEval(["(function(){try{window.", o, "=", e, ";}catch(_oError){}})();"].join("")),
            t = window[o],
            window[o] = null ,
            t
        },
